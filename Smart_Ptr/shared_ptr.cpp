...
int main(int argc, char **argv)
{
    ...
    // shape_ptr类型转换为circle型的shared_ptr,circle_ptr2的计数变为3
    shared_ptr<circle> circle_ptr2 = dynamic_pointer_cast<circle>(shape_ptr);
    cout<<"use count of circle_ptr2 is "<<circle_ptr2.use_count()<<endl;
    return 0;
}